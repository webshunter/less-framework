            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <?php $this->push('scripts') ?>
                      ...
                      function passupdate(){
                        var data = Object.fromEntries(new FormData(document.getElementById('setting-pass')).entries());
            ...
            <div class="card">
                <div class="card-body">
                    <table  class="w-100">
                      ...
                      <form id="setting-pass">
                        <div class="modal-body">
                          <div class="form-group">
                            <label>Username</label>
                            <input type="hidden" name="idsiswa" id="idsiswa" value="<?= $datas->idsiswa ?>" />
                            <input type="username" name="username" class="form-control" value="<?= $datas->username ?>" />
                          </div>
                          <div class="form-group">
                            <label>Password</label>
                            <input type="password" name="password" class="form-control" value="<?= $datas->password ?>" />
                          </div>
                        </div>
                    </form>
